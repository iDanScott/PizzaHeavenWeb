...
<html>
    ...
    <body>
            ...
            <header class="banner">
                <header class="subbanner">
                    ...
                    <%
                        ...
                        if (!session.getAttribute("previousPage").equals(null)){
                            response.setHeader("Refresh", "10;url=" + session.getAttribute("previousPage"));
                        } else {
        ...
        <div id ="welcome">
            <h8>Thank you for registering with Pizza Heaven.</h8>
            <footer>
                <h10>
                    Legal details.
                    Social media links.
