//Provided by https://getaddress.io/js/jquery.getAddress-2.0.5.min.js
//Modified to fit PizzaHeaven website
(function(n) {
    "use strict";
    ...
    t.prototype.setAddressFields = function(n, t) {
        ...
        var mergedlines = $("#deliverylineone").val();
        var splitlines = mergedlines.split(" ");
        $("#deliverylineone").val(splitlines[0]);
        mergedlines = splitlines[1];
        for (i = 2; i < splitlines.length; i++){
            mergedlines += " ";
            mergedlines += splitlines[i];
        }
        $("#deliverylinetwo").val(mergedlines);
    };
    n.getAddress = {
        defaults: function() {
            return f
