 ...
 */
@WebServlet(name = "DrinkMenuServlet", urlPatterns = {"/DrinkMenuServlet"})
public class DrinkMenuServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Drink[] drinkList = drinkController.get();
        Image[] imageList = imageController.get();
